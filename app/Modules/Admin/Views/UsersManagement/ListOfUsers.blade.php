...
@section('css')
    <link rel="stylesheet" href="/css/admin/users-management/list-of-users.css" type="text/css" media="all"/>
@stop

@section('scripts')
    <script>
        var url = {
            listOfUsers: '{{route("ListOfUsers")}}',
            updateStatus: '{{route("UpdateStatusOfUser")}}',
        }
    </script>
    <script src="/js/admin/users-management/list-of-users.js" type="text/javascript"></script>
@stop
...
<div class="row">
        ...
        <div class="x_panel">
            ...
            <div class="x_content" id="condition-search">
                <form class="form-horizontal input_mask" id="form-search" action="" accept-charset="UTF-8" method="get">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <button type="button" class="btn btn-primary" id="btn-search" link-search="{{route("ListOfUsers")}}">{{__('Search')}}</button>
                        </div>
    ...
    <div class="col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content" id="div-table-users">
                @include('Admin::UsersManagement.TableUser')
            </div>
        </div>
    </div>
</div>
