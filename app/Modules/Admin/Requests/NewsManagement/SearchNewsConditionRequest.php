<?php
/**
 * SearchNewsConditionRequest
 * Request for validate and set default values for search slides
 *
 * 処理概要/process overview  : SearchNewsConditionRequest
 ...
 * @version 1.0.0
 */
namespace App\Modules\Admin\Requests\NewsManagement;

use App\Http\Requests\CommonRequest;

class SearchNewsConditionRequest extends CommonRequest
{
    /**
