 ...
 * list-of- client.js
 *
 * Description		:	Methods and events for list of  client
...
$(document).ready(function () {
    ListOfClientsModule.Init();
    ListOfClientsModule.InitEvents();
});

/**
 * Module contains handling for list of  client
 * Author       :  TriTD - create
 * Param        :
 * Output       :   ListOfClientsModule.Init() - Initialize values
 * Output       :   ListOfClientsModule.InitEvents() - Initiating events
 */
var ListOfClientsModule = (function () {
    /**
        ...
        try {
            ...
            $.ajax({
                ...
                success: function (res) {
                    $('#div-table-client').html(res);
                    AdminCommonModule.InitPage();
                    AdminCommonModule.InitCheckboxAndRadio();
                    Common.SetTabindex();
                    Common.ChangeUrl('ListOfClients', Common.GetLastOfUrl(url.listOfClients) + '?' + Common.Serialize(data));
                    $("#search").focus();
                },
                error: function () {
