 ...
 * list-of- location.js
 *
 * Description		:	Methods and events for list of  location
...
$(document).ready(function () {
    ListOfLocationsModule.Init();
    ListOfLocationsModule.InitEvents();
});

/**
 * Module contains handling for list of  location
 * Author       :  TriTD - create
 * Param        :
 * Output       :   ListOfLocationsModule.Init() - Initialize values
 * Output       :   ListOfLocationsModule.InitEvents() - Initiating events
 */
var ListOfLocationsModule = (function () {
    /**
        ...
        try {
            ...
            $.ajax({
                ...
                success: function (res) {
                    $('#div-table-location').html(res);
                    AdminCommonModule.InitPage();
                    AdminCommonModule.InitCheckboxAndRadio();
                    Common.SetTabindex();
                    Common.ChangeUrl('ListOfLocations', Common.GetLastOfUrl(url.listOfLocations) + '?' + Common.Serialize(data));
                    $("#search").focus();
                },
                error: function () {
